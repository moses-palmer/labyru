...
//!
//! When physically laying out the maze, rooms and edges have certain attributes. These are
...
impl Pos {
    ...
    ///
    /// The length of the position vector is given by the square root of this value.
    ///
    /// # Example
    ///
    /// ```
...
impl ops::Sub for Pos {
    ...
    /// Subtracts the axis values of another position from the axis values of this one.
    ///
    /// # Example
    ///
    /// ```
...
impl ops::Add<Angle> for Pos {
    ...
    ///
    /// This is equal to to adding the position vector generated by the cosine and sine values of
    /// the angle.
    ///
    /// # Example
    ///
...
///
/// The remaining corners are retrieved by adding the width and height the the corner coordinates.
#[derive(Clone, Copy, Debug, PartialEq)]
pub struct ViewBox {
    /// A corner.
    ///
    /// The coordinates of the remaining corners can be calculated by adding `width` and `height`
    /// to this value.
    pub corner: Pos,
...
impl ViewBox {
    ...
    ///
    /// The centre is maintained, but every side will be `d` units further from it.
    ///
    /// If `d` is a negative value, the view box will be contracted, which may lead to a view box
