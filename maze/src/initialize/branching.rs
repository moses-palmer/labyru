...
{
    loop {
        // Start with all walls in a random room, except for those leading out of the maze
        ...
        while !walls.is_empty() {
            ...
            if candidates[next_pos] {
                ...
                // Add all walls of the next room except those already visited and those outside of
                // the maze
                walls.extend(
                    maze.walls(next_pos)
                        .iter()
