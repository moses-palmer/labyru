    ...
    R: initialize::Randomizer + Sized + Send + Sync,
{
    ...
    {
        let points = voronoi::initialize::Methods::random_points(maze.viewbox(), rng)
...
pub enum HeatMapType {
    ...
    /// The heat map is generated by travesing from every edge room to the one on the opposite
    /// side.
    Full,
}
